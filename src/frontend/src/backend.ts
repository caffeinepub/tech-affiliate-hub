...
export class Backend implements backendInterface {
    ...
    async getAllFeaturedProducts(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFeaturedProducts();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllTodaysDeals(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTodaysDeals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFeaturedProduct(arg0: string): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeaturedProduct(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTodaysDeal(arg0: string): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodaysDeal(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
